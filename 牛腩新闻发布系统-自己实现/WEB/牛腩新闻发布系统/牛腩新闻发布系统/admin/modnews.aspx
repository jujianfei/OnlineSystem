<%@ Page Title="修改新闻" Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/m_common.master" ValidateRequest="false" CodeBehind="modnews.aspx.cs" Inherits="牛腩新闻发布系统.admin.modnews" %>
