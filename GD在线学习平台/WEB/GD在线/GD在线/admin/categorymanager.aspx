<%@ Page Title="" Language="C#" MasterPageFile="~/admin/m_common.master" AutoEventWireup="true" CodeBehind="categorymanager.aspx.cs" Inherits="GD在线学习平台.admin.WebForm1" %>
                ...
                <asp:Repeater ID="repCategory" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:LinkButton ID="lbtnDelCa_Click" runat="server" CommandArgument='<%#Eval ("id") %>' OnClientClick="return confirm('删除类别会导致其下资源及评论全部删除，是否要删除！')" OnClick="lbtnDelCa_Click">删除</asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
